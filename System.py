...
| ||_____||_____|| || ||____|  |____|| || | |____||____| | || |    |_____|   | || ||_____|\____| | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
""")
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089456588455&mibextid=ZbWKwL')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mJOIN MY GITHUB ')
    ...
    if opt == '2':
        ...
        return None
    if opt == '3':
        os.system('xdg-open https://github.com/protocol-networks/mahin.git')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089456588455&mibextid=ZbWKwL')
